...
# # TODO: This should inherit from Dock, but we first need to be able to set default parameters
# component Panel, CollapsablePanel():
...
# component Panel, DebugElem(label: string, elem: Element):
...
# component Panel, DebugTreeImpl(tree: Element, filterText: Observable[string]):
...
# component Panel, DebugTree(tree: Element):
#   # var accum = 0.0
